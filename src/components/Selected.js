...
function Selected(prop) {
  ...
  return (
    <tr>
      ...
      <td>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16" onClick={removeItem} data-category={prop.item.category}>
